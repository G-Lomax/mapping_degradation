...
rpi_ts_trend <- rast(here("results", "figures", "rf_rpi_ts_trend_rast.tif"))
...
rpi_kendall_tau <- rast(here("results", "figures", "rf_rpi_kendall_tau_rast.tif"))
