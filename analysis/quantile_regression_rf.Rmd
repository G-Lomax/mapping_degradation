...
spt_feature_set <- read_rds(here("results", "rds", "spt_features_1000.rds"))
# nspt_feature_set <- read_rds(here("results", "rds", "nspt_features.rds"))
spt_feature_select <- read_rds(here("results", "rds", "spt_feature_selector_1000.rds"))
...
write_rds(rf_tuned_spt, here("results", "rds", "rf_tuned_spt_100.rds"))
...
density_plot <- ggplot(data_with_quantiles_spt, aes(x = quantile_pred, y = GPP)) +
  ...
  geom_abline(slope = seq(0.2, 1, 0.2), intercept = 0, colour = "red", lwd = 0.2, linetype = "longdash") +
  geom_abline(slope = 1, intercept = 0, colour = "red") +
  theme_classic() +
  theme(legend.position = c(0.1, 0.8), legend.key.height = unit(1.5, "cm")) +
  xlim(0, 10) +
  ylim(0, 10) +
