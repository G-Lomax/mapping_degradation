...
In this document, I generate smooth, high-resolution NDVI time series for
...
## Extract Sentinel-2 NDVI time series data from Google Earth Engine
...
values across a circle of 50m radius centred on the plot location, including
only pixels identified as grass/open ground rather than trees or shrubs.


```{r full_ts, cache = T}

ts_all <- read_csv(here("data", "processed", "csv", "tpw",
                        "enonkishuTSValues_all_l1c.csv")) %>%
...
there is a lot of noise or not much data (e.g., in Orkoliliy) - but it
...
see the differences between sites like Enguko and those like Orkoliliy.
...
3.  The relationship between these values and rainfall.
