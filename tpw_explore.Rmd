...
tpw_points <- st_read("raw_data/vector/tpw/Rangeland_Ufuatiliaji_wa_Nyanda_za_Malisho.shp")
tpw_table <- read_csv("raw_data/csv/tpw/samplemetrics.csv")
tz <- st_read("raw_data/vector/natural_earth/ne_110m_admin_0_countries_fixed.shp") %>%
...
#          "processed_data/vector/tpw/tpw_locations.shp",
#          delete_dsn = T)
...
tpw_bands <- read_csv("processed_data/csv/tpw/tpwMonthlyValues.csv") %>%
...
ggsave("figures/ndvi_p1.jpg", p1,
       width = 24, height = 16, units = "cm")
ggsave("figures/ndvi_p2.jpg", p2,
       width = 24, height = 16, units = "cm")
ggsave("figures/ndvi_p3.jpg", p3,
       width = 24, height = 16, units = "cm")
ggsave("figures/ndvi_p4_simple.jpg", p4,
       width = 24, height = 16, units = "cm")
